...
`define sg                                // sg15E is equivelant to the JEDEC DDR3-1333H (9-9-9) speed bin
    ...
    parameter TIS              =     185; // tIS        ps    Input Setup Time
    ...
    parameter TCKE             =    20000; // tCKE       ps    CKE minimum high or low pulse width
...
`define custom_part_width
    parameter TRRD             =    20000; // tRRD       ps     Active bank a to Active bank b command time
